...
export const metadata: Metadata = {
  ...
  description:
    'Take a free IQ-style test online with logic, pattern, numerical, spatial, and analogy questions. Get an Estimated IQ, percentile, category strengths, and clear explanations for practice.',
    ...
    <main id="main-content">
      <section className="home-hero shell">
        <div className="hero-copy">
          ...
          <p>
            Take a carefully authored, free IQ-style test across logic, pattern,
            numerical, spatial, and analogy questions. Receive an Estimated IQ,
            percentile, and category strengths in minutes.
          </p>
        ...
        <div
          ...
          aria-label="Interactive assessment preview"
        >
        ...
        <div className="learning-grid">
          ...
          <article>
            ...
            <p>
              ...
              not prove how you compare with a representative population. Sleep,
              language, familiarity, attention, and accessibility can all affect
              a short online attempt.
            </p>
          </article>
          <article>
            ...
            <p>
              ...
              or take a new randomized test. Retakes are useful for learning,
              but scores from repeated practice should not be compared as if
              they were independent clinical measurements. Notice which
              explanations change your approach and use those observations to
              guide study.
            </p>
          </article>
          <article>
            ...
            <p>
              ...
              that device. IQTestReal does not sell test answers or claim access
              to private psychological data. Advertising and analytics remain
              disabled until they are configured, disclosed, and reviewed. Read
              the <Link href="/privacy-policy">Privacy Policy</Link> and{' '}
              <Link href="/cookie-policy">Cookie Policy</Link> for the current
              details, or send a question through{' '}
          ...
          <article>
            ...
            <p>
              ...
              unfamiliar, read its explanation, try a similar puzzle, and return
              later without pressure. Keep notes about the rule you missed, the
              clue you overlooked, and the method that eventually worked. This
              turns an online IQ test into a small learning loop: attempt,
              review, practise, and reflect. It also keeps the score in its
              proper place—as feedback about one session, not a definition of
              your potential. Clear explanations make the exercise useful for
