...
function PetArt({ pet, dragging, reacting, landing, sleeping, size = 'large' }: { pet: Pet; dragging: boolean; reacting: boolean; landing: boolean; sleeping: boolean; size?: 'large' | 'small' }) {
  ...
  return <svg className={classes} viewBox="0 0 140 150" role="img" aria-label={`${pet.species} companion`} focusable="false">
    ...
    {pet.id === 'snake' && <><g className="pet-body"><path className="pet-snake-body" d="M26 112 C42 91 60 122 78 106 C91 95 101 102 108 91" fill="none" stroke={pet.color} strokeWidth="16" strokeLinecap="round"/><path className="pet-snake-highlight" d="M31 108 C45 96 60 117 77 102" fill="none" stroke="#c7dc78" strokeOpacity=".7" strokeWidth="4" strokeLinecap="round"/></g><g className="pet-head"><path d="M97 77 C99 59 116 48 129 58 C140 66 135 83 121 88 C110 92 99 87 97 77Z" fill={pet.color}/><path d="M122 84 Q132 84 139 89" fill="none" stroke="#e7a45d" strokeWidth="2" strokeLinecap="round"/><ellipse className="pet-eye" cx="119" cy="67" rx="3.5" ry="4.5" fill="#192326"/><path d="M104 84 C100 91 94 94 88 95" fill="none" stroke="#e6584f" strokeWidth="2" strokeLinecap="round"/><path d="M88 95 l-5 -3 M88 95 l-4 4" stroke="#e6584f" strokeWidth="1.5" strokeLinecap="round"/></g></>}
